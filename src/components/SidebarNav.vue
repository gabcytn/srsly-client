...
<template>
  <SidebarDrawer />
  <Menu :model="navItems" class="hidden md:flex w-70 min-h-dvh flex-col pb-5 bg-mycard">
    <template #start>
      <span class="inline-flex items-center gap-1 py-4 ps-5">
        <span class="text-xl font-semibold font-jetbrains-mono"
          ><span class="text-primary font-jetbrains-mono">srs</span>ly</span
        >
      </span>
    </template>
